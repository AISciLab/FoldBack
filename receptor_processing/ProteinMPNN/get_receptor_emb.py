...
if __name__ == "__main__":
    ...
    parser.add_argument("--pdb-path", type=str, default="../../example/receptor.pdb",help="Path to the PDB file which structural features will be extracted.")
    parser.add_argument("--out-path", type=str, default="../../example/receptor_structure_emb.pkl",help="Path to the output PKL file where the extracted features will be saved.")
